...
def main():
    model = pkl.load(open('C:/Users/Nilanjana/Documents/2021-2025/2022-2025 KSIT/KSIT/2nd to 4th year (2022-2025)/3rd Year (2023-2024)/6th Sem/7) Mini Project/project/Car_Price_Prediction_Model.pkl', 'rb'))

    st.header('Car Price Predictor')

    cars_data = pd.read_csv('cardekho.csv')
    ...
    name = st.selectbox('Which car brand would you want?', cars_data['name'].unique())
    ...
    if st.button("Predict"):
        ...
        st.write(f'Car price is estimated to be ₹{car_price}')